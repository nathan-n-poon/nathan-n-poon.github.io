...
// function changeTextColour(colour, object) {
//   // object.style.color = colour;
//   console.log("JELLO");
// }
...
// {
//   toChange[i].addEventListener('mouseover', changeTextColour('blue', toChange[i]));
//   toChange[i].addEventListener('mouseexit', changeTextColour(baseColour, toChange[i]));
// }
...
function changeBackground() {
  if(vw(100) <= 500 || window.mobileCheck()) {
    ...
    // document.getElementById("welcomeDiv").getElementsByTagName("p").style.zIndex = 10;
    // console.log(spencer);
    if(!window.mobileCheck)
    {
